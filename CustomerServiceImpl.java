...
public class CustomerServiceImpl implements CustomerManager {
	...
	@Override
	public List<CustomerDTO> getAllCustomerDetails() throws AppException {
	...
	@Override
	public CustomerDTO findByCustomerNumber(Integer customerNumber) throws AppException {
		...
		try {
			...
			throw new AppException(String.valueOf(customerNumber));
		}
		...
		customerdto = convertCustomerToCustomerDTO(customerList);
	        ...
	        throw new AppException("customer Number not found");
		}
		return customerdto;
	}
	...
	@Override
	@Transactional
	public CustomerDTO saveCustomerDetails(CustomerDTO customerDTO) throws AppException {
		...
		try {
			...
			LOGGER.error("Error inside Exception saveCustomerDetails customerDTO {} exception {}", customerDTO,
					exception);
			throw new AppException(String.valueOf(customerDTO));
		}
		return customerDTO;
	}
