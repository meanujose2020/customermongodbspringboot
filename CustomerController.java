...
public class CustomerController {
	...
	public List<CustomerDTO> getAllCustomerDetails() throws Exception, AppException {
		...
		try {
			...
			throw ExceptionHelper.createMqttException(exception);
		}
	...
	public ResponseEntity<CustomerDTO> createCustomer(@RequestBody CustomerDTO customerDTO) throws Exception {
		...
		try {
			...
			throw ExceptionHelper.createMqttException(appException);
		}
		if (LOGGER.isInfoEnabled()) {
